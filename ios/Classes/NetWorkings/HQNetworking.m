...
NSString *const HQNetworkingReviewUrl = @"https://app-api.kosun.cc:8888/Home/app/reviewStatus";
NSString *const HQNetworkingConfigUrl = @"https://app-api.kosun.cc:8888/Home/app/getConfigurationByUniqueId";
